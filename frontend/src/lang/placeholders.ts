...
const placeholderTexts: Record<PlaceholderLanguage, PlaceholderText> = {
  English: {
    ...
    noFileSelectedSubtitle: "Click to select a file",
  ...
  Romanian: {
    ...
    noFileSelectedSubtitle: "Click pentru a selecta un fisier",
  ...
  Spanish: {
    ...
    noFileSelectedSubtitle: "Haz clic para seleccionar un archivo",
  ...
  "Modern Standard Arabic": {
    ...
    noFileSelectedSubtitle: "انقر لتحديد ملف",
  ...
  French: {
    ...
    noFileSelectedSubtitle: "Cliquez pour sélectionner un fichier",
  ...
  Russian: {
    ...
    noFileSelectedSubtitle: "Нажмите, чтобы выбрать файл",
  ...
  German: {
    ...
    noFileSelectedSubtitle: "Klicken Sie, um eine Datei auszuwählen",
  ...
  Japanese: {
    ...
    noFileSelectedSubtitle: "クリックしてファイルを選択",
  ...
  Vietnamese: {
    ...
    noFileSelectedSubtitle: "Nhấp để chọn một tệp",
  ...
  Turkish: {
    ...
    noFileSelectedSubtitle: "Dosya seçmek için tıklayın",
